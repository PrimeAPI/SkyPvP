...
public class FlyCommand {
	...
	public void fly(@SenderField PrimePlayer primePlayer, @SingleAttribute(name = "player", required = false) Player target){

		Player player;

		if(target == null) player = primePlayer.thePlayer();
		else {
			player = target;
