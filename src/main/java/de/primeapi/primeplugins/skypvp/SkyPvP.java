...
public class SkyPvP extends JavaPlugin {
	...
	public void onEnable() {
		...
		CommandHandler.registerClass(this, MainCommand.class, FlyCommand.class, WorkbenchCommand.class, GamemodeCommand.class, TeleportCommand.class, TPHereCommand.class);
